...
class WhatsAppBulkMessengerTester:
    def __init__(self, base_url="https://whatsapp-qa-flow.preview.emergentagent.com"):
    ...
    def test_create_saved_template_with_media(self):
        ...
        template_data = {
            ...
            "header_image": "https://whatsapp-qa-flow.preview.emergentagent.com/uploads/images/test.jpg"
        }
    ...
    def test_update_saved_template(self):
        ...
        update_data = {
            ...
            "header_video": "https://whatsapp-qa-flow.preview.emergentagent.com/uploads/videos/test.mp4"
        }
